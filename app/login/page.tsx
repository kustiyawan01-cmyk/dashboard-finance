...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center font-sans bg-[#006CD0]">
      ...
      {/* Kotak Putih Latar Belakang (Seperti Canvas di Gambar) */}
      <div className="absolute bg-white/10 backdrop-blur-sm w-[90%] max-w-[1000px] h-[600px] rounded-[40px] shadow-2xl z-0 hidden lg:block overflow-hidden">
         ...
         {/* Tambahan curve biru di dalam kotak putih kanan */}
      ...
      <div className="bg-white w-full max-w-[400px] rounded-[30px] p-10 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.3)] z-10 relative animate-in fade-in duration-500">
        ...
        <form className="space-y-4" onSubmit={handleLogin}>
          {error && (
            <div className="bg-red-50 text-red-600 px-4 py-2 rounded-lg text-[13px] font-medium text-center">
              {error}
            </div>
          )}
          ...
          <div>
            <input
              ...
              className="w-full px-5 py-3.5 bg-[#F4F4F4] border-transparent rounded-[14px] text-[13px] text-slate-800 focus:bg-white focus:border-[#006CD0] focus:ring-1 focus:ring-[#006CD0] outline-none transition-all placeholder:text-slate-400 font-medium"
          ...
          <div className="relative">
            <input
              ...
              className="w-full pl-5 pr-12 py-3.5 bg-[#F4F4F4] border-transparent rounded-[14px] text-[13px] text-slate-800 focus:bg-white focus:border-[#006CD0] focus:ring-1 focus:ring-[#006CD0] outline-none transition-all placeholder:text-slate-400 font-medium"
          ...
          <div className="pt-1 pb-2">
            <a href="#" className="text-[11px] font-bold text-[#006CD0] hover:underline">
              Forgot Password?
            </a>
          </div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full flex justify-center items-center py-3.5 px-4 rounded-[14px] text-sm font-bold text-white bg-[#006CD0] hover:bg-[#005AB5] focus:outline-none disabled:opacity-70 transition-all shadow-md shadow-[#006CD0]/30"
          >
